								...
								<div class="col mr-2">
									<div class="card-body">
										...
										<input name="nama" type="text" value="<?= $kue['nama']; ?>" readonly class="form-control" class="form-control" id="nama"> -->
											...
											<!-- <div class="form-group">
												<label for="p">Harga</label>
												<input name="p" value="<?= $poin; ?>" type="hidden" readonly class="form-control" class="form-control" id="p">
											</div> -->
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="text" name="tpoin" value="<?= $kue['poin']; ?>" id="poin" readonly class="form-control">
											</div>
											<div class="form-group">
