...
<div class="products">
    <div class="container">
        <div class="row">
                ...
                <div class="filters">
                    <ul>
                        <li class="active" data-filter="*">
                            <img src="<?= base_url('assets/template/') ?>assets/images/icon-2.png" alt="All Products"><br>
                            All Products
                        </li>
                        <li data-filter=".des">
            ...
            $produk_terbaru = array_slice($kue, $offset, $itemsPerPage);

            // Calculate the total number of pages
            $totalPages = ceil(count($kue) / $itemsPerPage);
